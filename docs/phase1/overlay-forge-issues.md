...
- **回灌枝：** `cursor/lg-upstream-of-9bdf`（基 `upstream/main` @ `ec9e129`）。Oliver 打源仓 PR：`LibertychaserUS:cursor/lg-upstream-of-9bdf` → `First-Light-TechHK:main`。agent 不推 `upstream`。
